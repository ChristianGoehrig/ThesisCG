...
# NOTE: snow_site_analysis.py is not part of this repository. This run-script
# was written against an earlier, separate module that has since been folded
# into powdersearch.py (see e.g. analyze_stations_with_circular_filter) but
# was never ported to match this script's parameter set. Provide your own
# snow_site_analysis.py exposing run_site_representativity_analysis with the
# signature used below, or adapt this script to call powdersearch directly.
...
INPUT_FOLDER = r""  # Directory containing snow depth rasters
STATION_LOCATIONS = r""  # CSV file with station locations (optional)
DEM_PATH = r""  # DEM file for elevation analysis (optional)
