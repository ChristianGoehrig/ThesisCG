...
def analyze_stations_with_circular_filter(csv_path, input_filepaths, buffer_radius, output_folder=None, meta=None):
    ...
    for _, station_row in stations_df.iterrows():
        ...
        deviations = calculate_yearly_deviation_metrics(station_areas, all_year_stats_buffer, deviations_output_path,meta)
...
def calculate_yearly_deviation_metrics(input_data, yearly_stats, output_folder=None, meta = None, date=None):
    """
    Calculate deviation metrics for each year's snow depth.
